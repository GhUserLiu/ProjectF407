...
def generate_template(output_path: str = None) -> str:
    ...
    Args:
        output_path: 输出文件路径，默认为当前目录下的"实验报告模板.docx"
...
if __name__ == '__main__':
    # 默认输出到 docs 目录
    default_output = Path(__file__).parent.parent.parent / 'docs' / '实验报告模板.docx'
    output_path = generate_template(str(default_output))
    print(f'实验报告模板已生成: {output_path}')
