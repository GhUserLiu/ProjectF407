...
**您的报告与其他同学高度相似（最高相似度：99.2%），系统检测为抄袭。**

**与以下同学的报告高度相似：**

| 学号 | 姓名 | 相似度 | 说明 |
|------|------|--------|------|
| 23071140211 | 汽服2302B班-23071140211-安晓童 | 🔴 100.0% | 同组 |
| 23071140237 | 汽服2302B班-23071140237-刘烊宏 | 🔴 99.2% | 同组 |
...
### ❌ principle_understanding (9.2/100)
- 实验目的清晰完整
- 实验原理阐述准确
- 汽车电子应用场景说明
- 语义匹配: 实验目的清晰完整 实验目的 目标 预期 成果... (相似度60%)
- 语义匹配: 实验原理阐述准确 实验原理 基本原理 外部中断 DWT 消抖... (相似度88%)
- 语义匹配: 汽车电子应用场景说明 汽车电子 应用 场景 背景 TCU E... (相似度62%)
...
- 语义匹配: 代码注释详尽 注释 说明 解释 关键语句... (相似度60%)

### ❌ report_quality (5/100)
- 调试问题记录真实（六）
- 团队协作解决过程（六）
- 个人心得独立且深刻（六）
- 思考题回答完整正确（七）
